...
import { FaGithub, FaInstagram, FaLinkedin, FaWhatsapp, FaTelegramPlane} from 'react-icons/fa'
...
export default function HomePage() {
  ...
  return (
    <div className="relative flex min-h-full w-full flex-col items-center justify-center">
       <canvas
        className="bg-skin pointer-events-none absolute inset-0"
        id="canvas"
      ></canvas>
      <div className="relative flex items-center justify-center py-3">
        <h1 className="relative flex-1">
          ...
          <span className=" z-10 block text-[calc(1.825rem+6.9vw)] font-bold leading-none">Dim Pavlyuk</span>{' '}
        ...
        <div className="absolute -bottom-1/4 mx-auto flex">
          ...
          <a href={SOCIALS.TG} aria-label="TG" target="_blank" rel="noopener" className="mx-2 block p-2 opacity-80 hover:opacity-95">
