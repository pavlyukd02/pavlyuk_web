    ...
    <>
      ...
      <div className="fixed left-0 top-0 h-full w-full overflow-hidden bg-white dark:bg-black">
        <Image
          ...
          className="block h-full w-full object-cover object-[80%_28%]"
        />
        {isVideoPlayed && (
          <video src="/media/video-main1.mov" loop autoPlay className={'absolute top-0 z-10 block h-full w-full object-cover object-[80%_28%]'} />
        )}
      </div>
    </>
  )
