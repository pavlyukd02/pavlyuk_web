...
export const PROJECTS = [
  {
    id: 1,
    title: "Ollie Studio",
    des: "A studio that embodies modern ideas in interior design.",
    img: "/p1_img.png",
  ...
  {
    id: 2,
    title: "The Book - History of Spaske",
    des: "Web presentation of the book by Ukrainian local historians.",
    img: "/p2_img.png",
    iconLists: ["Vite Js", "TailWindCSS", "Google Firebase", "FirebaseAuth", "Firestore"],
  ...
  },
  {
    ...
    img: "/p3_img.png",
    iconLists: ["Next Js", "TailWindCSS", "GSAP", "Three Js"],
    link: "https://websiteforportfolioiphone.web.app/",
  },
  {
    id: 4,
    title: "Brainwave - Beautiful landing page",
    des: "Brainwave is a modern, stylish landing page built with ViteJs, featuring smooth routing, parallax effects, and scroll locking. Styled with Tailwind CSS.",
    img: "/p4_img.png",
    iconLists: ["Vite JS","TailWindCSS", "React-Parallax"],
    link: "https://brainwawave-landing-page.web.app/",
  },
];
